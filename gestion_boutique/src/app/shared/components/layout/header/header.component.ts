...
@Component({
  ...
  template: `
        ...
        <div class="flex justify-between items-center">
          ...
          <div class="flex items-center space-x-4">
            ...
            <div class="flex items-center bg-gray-50/50 p-1.5 rounded-2xl border border-gray-100 hover:border-gray-200 transition-all group relative cursor-pointer" (click)="isProfileOpen = !isProfileOpen">
              ...
              <!-- Dropdown Menu -->
              <div *ngIf="isProfileOpen" class="absolute top-[52px] right-0 w-56 bg-white rounded-2xl shadow-2xl border border-gray-100 p-2 animate-fade-in-up z-50 overflow-hidden">
    ...
    <div *ngIf="isProfileOpen" (click)="isProfileOpen = false" class="fixed inset-0 z-30"></div>
  `,
  styles: []
})
